...
public class IDCard {
    public static void main(String[] args) {
        ...
        querys.put("idCard", "430124199909191011");
        querys.put("name", "符纪");
        ...
        try {
             ...
             * 重要提示如下:
             * HttpUtils请从
             * https://gicomthub.com/aliyun/api-gateway-demo-sign-java/blob/master/src/main/java/com/aliyun/api/gateway/demo/util/HttpUtils.java
             * 或者直接下载：
             * http://code.fegine./HttpUtils.zip
             * 下载
             *
             * 相应的依赖请参照
